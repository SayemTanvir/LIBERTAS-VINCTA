...
| --- | --- | --- | --- | --- | --- |
| `assets/BG/11_intro/*.png` | Not identified in supplied folder | Supplied by project owner | Not supplied | Runtime atlas crops, bat alignment, alpha cleanup and layered cinematic composition; original PNGs unchanged | Not supplied |
